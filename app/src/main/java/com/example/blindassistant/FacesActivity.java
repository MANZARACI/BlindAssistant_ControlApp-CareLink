...
public class FacesActivity extends AppCompatActivity implements FaceRecyclerViewInterface {
    ...
    private static final String newFaceUrl = BuildConfig.BACKEND_URL + "/face/add-face-base64";
    private static final String fetchFacesUrl = BuildConfig.BACKEND_URL + "/face";
    private static final String deleteFaceUrl = BuildConfig.BACKEND_URL + "/face/delete-face";
